 ...
 */
    ...
    (() => {
        ...
        if (document.querySelector(".popular-destinations__slider")) new core(".popular-destinations__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".teams__slider")) new core(".teams__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".left-product__images")) {
        ...
        if (document.querySelector(".tabs-left-product__slider")) {
            const tabsSlider = new core(".tabs-left-product__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
...
***************************************************************************** */
        ...
        if (favourites) favourites.forEach((favourite => {
        ...
        if (filterTabsButtons) filterTabsButtons.forEach(((button, i) => {
            ...
            window.addEventListener("click", (e => {
                ...
                if (!target.closest(".body-filter-tabs__simplebar") && !target.closest(".drop-down-titles") && !target.closest(".body-filter-tabs__title-mob")) {
                    button.classList.remove("_active");
                    if (shadow) shadow.classList.remove("_active");
                    document.documentElement.classList.remove("filter-open");
                }
            }));
            if (filterTabsClose) filterTabsClose.forEach((close => {
                close.addEventListener("click", (function(e) {
                    button.classList.remove("_active");
                    if (shadow) shadow.classList.remove("_active");
                    document.documentElement.classList.remove("filter-open");
        ...
        if (filterSearchButtons) filterSearchButtons.forEach(((button, i) => {
            const filterSearchArrow = button.querySelector(".checkbox__arrow");
            if (filterSearchArrow) filterSearchArrow.addEventListener("click", (function(e) {
                let elem_active = button.classList.contains("_active");
        ...
        if (checkboxBlocks) checkboxBlocks.forEach((block => {
            let allCheckBox = block.querySelector(".main-checkbox-spoller");
            let otherCheckBoxes = block.querySelectorAll(".checkbox-spoller");
            if (allCheckBox) {
                otherCheckBoxes.forEach((item => {
                    item.addEventListener("click", (function() {
                        let checkBoxes = document.querySelectorAll(".checkbox-spoller:checked");
        ...
        if (searchFilterButton) {
            ...
            window.addEventListener("click", (e => {
                const target = e.target;
                if (!target.closest(".filters-search__content") && !target.closest(".title-mob") && !target.closest(".search__filter")) document.documentElement.classList.remove("filter-search-active");
            }));
            if (closes) closes.forEach((close => {
                close.addEventListener("click", (function(e) {
                    document.documentElement.classList.remove("filter-search-active");
                }));
            }));
        }
        const script_stickyBlock = document.querySelector(".right-product-sticky");
        function sticky() {
            ...
            if (floatingButton) {
                ...
                if (document.documentElement.clientWidth < 479.98) footer.style.marginBottom = hfloatingButton + "px"; else footer.style.marginBottom = "0";
            }
            if (script_stickyBlock) if (document.documentElement.clientWidth > 991.98) {
                script_stickyBlock.style.top = hheader + "px";
                if (searchBottom) {
                    let hsearchTop = window.getComputedStyle(searchTop, false).height;
                    hsearchTop = Number(hsearchTop.slice(0, hsearchTop.length - 2));
                    let sum = hheader + hsearchTop;
                    script_stickyBlock.style.top = sum + "px";
                }
            } else script_stickyBlock.style.top = "0";
        ...
        if (searchRoomButton) {
            ...
            window.addEventListener("click", (e => {
                const target = e.target;
                if (!target.closest(".search-room__title-mob") && !target.closest(".search-room__buttons") && !target.closest(".body-filter-tabs__simplebar") && !target.closest(".drop-down-titles") && !target.closest(".body-filter-tabs__close")) document.documentElement.classList.remove("search-room-open");
            }));
        }
        ...
        if (mainSearchButton) {
            ...
            window.addEventListener("click", (e => {
                const target = e.target;
                if (!target.closest(".search__tabs") && !target.closest(".search__title-mob") && !target.closest(".search__content") && !target.closest(".body-filter-tabs__simplebar") && !target.closest(".drop-down-titles") && !target.closest(".body-filter-tabs__close")) document.documentElement.classList.remove("search-active");
            }));
        }
